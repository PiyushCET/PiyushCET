# 🪐 Piyush Kumar Sahoo | Computational Geometry & Rendering Portfolio

<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=24&pause=1000&color=F8F8F2&center=true&vCenter=true&width=800&height=50&lines=Procedural+Geometry+Architect;Mathematical+Graphics+Programmer;Low-Level+Rasterization+Mechanic;Numerical+Synthesis+Researcher" alt="Typing Animation" />
</p>
...
<p align="center">
  ...
  <a href="#-procedural-graphics--mathematical-art">🎨 Graphic Canvas</a> •
  <a href="#-analytical-geometry-engines">🚀 Implementation Portfolio</a>
</p>
...
* **Discrete Space Compression:** Serializing complex multi-dimensional spatial topologies into compact scalar primitives via discrete modulo and base arithmetic.
...
* **February 2020 | Trigonometric Fluid Meshes (The Fish Project):** Engineered an organic fish silhouette utilizing continuous periodic inequalities. Published the underlying analytical geometry mechanics on Quora, garnering **100,000+ views** and validating the massive global utility of visualizing pure calculus.
* **March 2020 | Composite Fields:** Conceptualized a multi-layered topological structure using a dense system of overlapping, intersecting ellipses and algebraic constraints.

### Phase 3: Hardware Drivers & Procedural Shading Architectures
* **April 2020 | Low-Level Graphic Subsystems:** Transitioned to the core C graphics environment (`graphics.h`). Rewrote over 300 lines of foundational rasterization algorithms from my previous implementations, shifting my focus toward hardware frame buffers and discrete palette architectures.
* **December 2020 | Materiality via Native Shading Engines:** Developed a custom HTML5 spatial layout application entirely from scratch for my major undergraduate project. Bypassing modern layout toolkits and CSS, I authored custom **anisotropic linear and radial shading algorithms** to simulate real-world object materiality, specular reflectivity, and depth purely via loop-level RGB intensity attenuation inspired by tactile interfaces like a television remote control.
...
## ⚡ Low-Level Compute Stack

```metrics
+---------------------------------------------------------------------------------+
|  MATHEMATICAL TOOLS      | Lagrange Interpolation · Continuous Conics · Affine  |
|  LOW-LEVEL RUNTIMES      | Core C++ · C · Java AWT · Python (Numba JIT)         |
|  GRAPHICS BUFFERING      | Raw Frame Buffers · NumPy Matrix Canvas · putpixel() |
+---------------------------------------------------------------------------------+
